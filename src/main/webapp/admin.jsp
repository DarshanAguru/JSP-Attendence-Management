...
if(request.getParameter("name") != null)
{
	...
	if(name.equals("admin") && pass.equals("admin@4"))
	{
		
		//out.print("<script>alert('Login success')</ecript>");
		out.print("<script>window.location.replace('home.jsp')</script>");
	}
	else{
...
<div class="container">
<center>
<h2 style="font-weight: bolder; font-size:  40px;  color: var(--text-color)"> Admin Login </h2>
</center>
<div class="login-form">
<form  action="" method="post">
<div id="name" class="main-text">Enter Username</div> 
<input class="inp-text" name = "name" type="text" value="" required>
