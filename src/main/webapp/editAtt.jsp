...
demo.User u = demo.data.getUserAtt(roll);
...
<div class="container">
<center>
<h2 style="font-weight: bolder; font-size:  36px;  color: var(--text-color)"> Edit Attendance </h2>
</center>
<div class="login-form">
<form action="updateAtt.jsp"  method="post">
...
<div class="main-text">Edit Attendance :</div> 
<input class ="inp-text" type="text"  name="uatt" value="<%= u.getAtt()%>">
...
<a class="btn-back" href="att.jsp">Back</a>
</div>
